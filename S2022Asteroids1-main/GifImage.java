...
public class GifImage
{
    ...
    public GifImage(GifImage copyFrom)
    {
        ...
        currentIndex = 0;//changed to allow copies to be independent
        time = System.currentTimeMillis();
    }

    /**
     * Get the last image used in the animation
     * @return the reference to the last image in the array of GreenfootImages
     */
    public GreenfootImage getLastImage(){
